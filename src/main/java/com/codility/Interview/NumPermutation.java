...
is NOT similar to 133 (there are different numbers of individual digits); 100 is NOT similar to 10 (010 contains
a leading zero, so it is not a correct decimal representation).
