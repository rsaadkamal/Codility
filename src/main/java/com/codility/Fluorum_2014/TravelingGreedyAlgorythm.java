...
// * int X; };
// *
// * Write a function: structure Results solution1(int K, int T[], int N);
// *
...
//
//    // The solution1 generated by the Greedy Algorithm
...
//
//	// 1. A candidate set, from which a solution1 is created
...
//
//	// 5. A solution1 function, which will indicate when we have discovered a
//	// complete solution1
//	while (!isCompleteSolution()) {
//
//	    // Adding the current solution1 cities (only destiny cities, not all
...
//    }
//
//    // 4. An objective function, which assigns a value to a solution1, or a
//    // partial solution1
