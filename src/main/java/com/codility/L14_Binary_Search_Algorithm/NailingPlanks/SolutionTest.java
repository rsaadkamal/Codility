...
public class SolutionTest {
    ...
    public void solution() throws Exception {
        assertEquals(4, new Solution().solution(new int[]{1, 4, 5, 8}, new int[]{4, 5, 9, 10}, new int[]{4, 6, 7, 10, 2}));
    }

    @Test
    public void solution2() {
        assertEquals(5, new Solution().solution(
    ...
    public void solution3() {
        assertEquals(4, new Solution().solution(
    ...
    public void testVersusNativeSolution() {
        ...
        for (int i = 0; i < testsCount; i++) {
            ...
            int res1 = new Solution().nativeSolution(testData.get(0).clone(), testData.get(1).clone(), testData.get(2).clone());
            int res2 = new Solution().solution(testData.get(0).clone(), testData.get(1).clone(), testData.get(2).clone());
            if (res1 != res2) {
