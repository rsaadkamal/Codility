...
//        assertEquals(30, new ArrayInversionCount.Solution().solution1(new int[]{15, 14, 4, 17, 8, 9, 9, 8, 8, 5}));
//    }
//
//    @Test
...
//            int res1 = new ArrayInversionCount.Solution().solution1(data.clone());
