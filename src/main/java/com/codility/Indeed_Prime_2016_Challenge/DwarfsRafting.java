...
similarly, the l and r sides of the raft (in terms of the columns of seats) must each contain the same number of dwarfs.
...
The raft is then balanced: both l and r halves have the same number of dwarfs (four), and both front and back halves have the same number of dwarfs (also four).
