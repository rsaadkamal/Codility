...
public final class p015 implements EulerSolution {
	...
	/* 
	 * This is a classic combinatorics problem. To get from the top l corner to the bottom r corner of an N*N grid,
	 * it involves making exactly N moves r and N moves down in some order. Because each individual down or r move
