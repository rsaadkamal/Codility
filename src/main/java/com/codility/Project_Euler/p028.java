...
public final class p028 implements EulerSolution {
	 ...
	 * It's not hard to convince yourself that the top r corner always has the value n^2.
	 * Working counterclockwise (backwards), the top l corner has the value n^2 - (n - 1),
	 * the bottom l corner has the value n^2 - 2(n - 1), and the bottom r is n^2 - 3(n - 1).
